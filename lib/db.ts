...
function createDb() {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS profiles (pubkey TEXT PRIMARY KEY REFERENCES users(pubkey), name TEXT, role TEXT, location TEXT, bio TEXT, lightning_addr TEXT, building TEXT, needs TEXT, vibe TEXT, core_vibe TEXT, invite_code TEXT, interests TEXT, personality TEXT, nostr_relays TEXT, lat REAL, lng REAL, updated_at INTEGER NOT NULL DEFAULT (unixepoch() * 1000));
